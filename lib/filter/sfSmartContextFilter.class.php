...
class sfSmartContextFilter extends sfFilter
{
    ...
    public function execute($filterChain)
    {
        ...
        if ($isEnabled && isset($moduleConfig['site'])) {
            $site = $moduleConfig['site'];
        }
        ...
        if ($isEnabled && isset($actionConfig['site'])) {
            $site = $actionConfig['site'];
        }
        ...
        if (true !== $isEnabled || !$this->isTrackable()) {
            return;
        }
